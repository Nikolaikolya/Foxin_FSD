...
``` bash
# Download repository:
git clone https://github.com/Nikolaikolya
...
**Usage:**
All files must be created in the `./src/hbs` folder.
Example:
``` bash
./src/hbs/index.hbs
```
...
2. Open new page `http://localhost:8081/about.hbs` (Don't forget to RERUN dev server)
...
Copyright (c) 2018-present, [Nikolai Fedotov](https://github.com/Nikolaikolya)